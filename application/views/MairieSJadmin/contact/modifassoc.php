<?php if (isset($_SESSION['log'])){?>
    ...
    <?php echo form_open(); ?>
                <div class="form-group">
                    ...
                    <label for="ass_mail"><b>Email Association :</b></label><input type="text" class="form-control" name="ass_mail" id="ass_mail" value="<?php echo set_value('ass_mail', $association->ass_mail);?>">
