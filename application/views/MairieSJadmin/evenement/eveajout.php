<?php if (isset($_SESSION['log'])){?> 
    ...
    <div class="row">
        <div class="col-12">
            <h2 class="d-flex justify-content-center"><Font color="blue">Ajout Evénement</font></h2>
        </div>
    </div>
    ...
    <?php echo form_open(); ?>
                <div class="form-group">
                   ...
                   <label for="eve_date"><b>Date Manifestation :</b></label><input type="text" class="form-control" name="eve_date" id="eve_date" value="<?php echo set_value('eve_date');?>">
                    ...
                    <label for="eve_contact"><b>Mail de l'organisateur :</b></label><input type="text" class="form-control" name="eve_contact" id="eve_contact" value="<?php echo set_value('eve_contact');?>">
                    <?php echo form_error('eve_contact'); // affiche l'erreur du champs nom obligatoire?>

                    <label for="eve_tel"><b>Téléphone de l'organisateur :</b></label><input type="text" class="form-control" name="eve_tel" id="eve_tel" value="<?php echo set_value('eve_tel');?>">
