<br>
    ...
    <br>
            ...
            <br>
            <h4 class="d-flex justify-content-center">Etes vous sûr de vouloir supprimer&nbsp<b><?=$evenement->eve_manif?></b>&nbspde la base de données ?<h4>
        ...
        <?php echo form_open(); ?>
                ...
                <div class="d-flex justify-content-center" name = actionassociation>    
                    ...
                    <a class="btn-primary ml-2"   href="<?= base_url("index.php/AdminStJust/evenement")?>">Retour</a>
                </div>
