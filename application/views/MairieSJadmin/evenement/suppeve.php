<?php if (isset($_SESSION['log'])){?> 
    ...
    <div class="row">
        <div class="col-12">
            <h2 class="d-flex justify-content-center"><Font color="blue">Evenement</Font></h2>
            <h3 class="d-flex justify-content-center"><Font color="blue">Suppression Evenement</Font></h3>
 ...
 <br>
            ...
            <h2 class="d-flex justify-content-center  ml-3 mr-3"><b><?=$evenement->eve_manif?></b></h2>
            <br>
            <div class="d-flex justify-content-center">
                <h4 class="ml-3 mr-3">Etes vous sûr de vouloir supprimer l'évenement &nbsp<b><?=$evenement->eve_manif?></b>&nbspde la base de données ?<h4>
            </div>
